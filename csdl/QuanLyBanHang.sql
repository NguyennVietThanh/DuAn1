...
insert into NhanVien values ([dbo].[AUTO_MaNV](),N'Nguyễn Việt Thành',1,N'Bình Định','0372795594','20020421','123',1);
insert into NhanVien values ([dbo].[AUTO_MaNV](),N'Nguyễn Tấn Phát',1,N'Quảng Nam','0378492759','20000504','123',0);
insert into NhanVien values ([dbo].[AUTO_MaNV](),N'Trần Duy Linh',0,N'Đà Nẵng','0358250091','19991205','123',0);
