...
//            System.out.println(lblCode.getText());
    ...
    private void refreshCodeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_refreshCodeMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_refreshCodeMouseEntered
    ...
    public void sendMail(){
        final String username = "nguyenvietthanh432004@gmail.com";
        final String password = "ollh bikf wujh covv";
        ...
        try {
            ...
            message.setFrom(new InternetAddress("nguyenvietthanh432004@gmail.com"));
