...
public class XImage {
    ...
    String file = "/store/app/icons/logoShop.png";
    ...
    public static boolean saveLogo(File file){
     File dir = new File("E:\\0DuAn_Nhom4\\src\\main\\images");  //khai báo thư mục logos ngang hàng với src
    ...
    File path = new File("E:\\0DuAn_Nhom4\\src\\main\\images", fileName);
